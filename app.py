...
def get_image_features(image_path_or_file):
    ...
    try:
        ...
        print(f"⚠️ Failed to load image: {image_path_or_file} ({e})", file=sys.stderr)
...
def apply_cors_headers(response):
    response.headers["Access-Control-Allow-Origin"] = "https://visual-product-matcher-frontend-nine.vercel.app"
